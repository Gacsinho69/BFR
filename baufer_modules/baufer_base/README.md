...
>
> **¿Y los submódulos?** En la rama principal este módulo vive dentro del repositorio sin submódulos Git. Solo si en tu fork ves un
> archivo `.gitmodules` o carpetas vacías, ejecuta `git submodule update --init --recursive` antes de copiar `baufer_base` a los
> addons de Odoo.
